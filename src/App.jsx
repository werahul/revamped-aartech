...
import {
  ...
  ShGovernanceReport,
  ShReconciliation,
  ShShareholdingPattern,
  FinancialReport,
  FRAuditYearlyReport,
  FRAuditHalfYearlyReport,
  Overview,
  FRFaradigm,
  FRSubsidiary,
  DisPolicies,
  Notices,
  FRSubsidiaryYearlyResult,
  FRFaradigmYearlyResult,
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            ...
            Component={SolarDesign}
          />
          <Route
            exact
            path="/products/solid-waste-treatment"
            Component={SolidWastePro}
          />
          ...
          <Route
            exact
            path="/investors/contact-and-grievance"
            Component={ContactAndGriv}
          />
          <Route exact path="/investors/disclosures" Component={Disclosures} />
          <Route exact path="/investors/downloads" Component={Downloads} />
          <Route
            exact
            path="/investors/chairman-communication"
            Component={Chairman}
          />
          <Route
            exact
            path="/investors/shareholders-information"
            Component={Shareholders}
          />
          <Route
            exact
            path="/investors/shareholders-information-compliance-certificates"
            Component={ShCompliance}
          />
          <Route
            exact
            path="/investors/shareholders-information-corporate-announcements"
            Component={ShCorporate}
          />
          <Route
            exact
            path="/investors/shareholders-information-corporate-governance-report"
            Component={ShGovernanceReport}
          />
          <Route
            exact
            path="/investors/shareholders-information-corporate-reconciliation-of-share-capital-audit-report"
            Component={ShReconciliation}
          />
          <Route
            exact
            path="/investors/shareholders-information-shareholding-pattern"
            Component={ShShareholdingPattern}
          />
          <Route
            exact
          ...
          <Route
            exact
            path="/investors/financial-reports-audit-yearly-report"
            Component={FRAuditYearlyReport}
          />
          <Route
            exact
            path="/investors/financial-reports-audit-half-yearly-report"
            Component={FRAuditHalfYearlyReport}
          />
          <Route exact path="/investors/overview" Component={Overview} />
          <Route
            exact
            path="/investors/financial-reports-faradigm-subsidiary-half-yearly-results"
            Component={FRFaradigm}
          />
          <Route
            exact
            path="/investors/financial-reports-subsidiary-half-yearly-results"
            Component={FRSubsidiary}
          />
          <Route
            exact
            path="/investors/disclosures-policies"
            Component={DisPolicies}
          />
          <Route exact path="/investors/notices" Component={Notices} />
          <Route
            exact
            path="/investors/financial-reports-subsidiary-yearly-results"
            Component={FRSubsidiaryYearlyResult}
          />
          <Route
            exact
            path="/investors/financial-reports-faradigm-subsidiary-yearly-results"
            Component={FRFaradigmYearlyResult}
          />

          <Route
            exact
            path="/media/award-presented-by-the-defense-minister"
            Component={Awards1}
          />
          <Route
            exact
            path="/media/recognised-by-the-department-of-scientific-and-industrial-research"
            Component={Awards2}
          />
          <Route
            exact
            path="/media/iso-9001-2015-certification"
            Component={Awards3}
          />
          <Route
            exact
            path="/media/serves-as-an-atal-incubation-centre"
            Component={Awards4}
          />
          <Route
            exact
            path="/media/winner-in-the-flctd-innovation-challenge-2022"
            Component={Awards5}
          />
