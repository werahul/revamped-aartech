...
const Media = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="max-container 2xl:px-[120px] lg:px-20 lg:py-20 px-5 py-10 sm:px-10">
                        ...
                        <Link to={item.paths}>
                            <div key={item.id} className="flex lg:flex-row flex-col border-[1px] mb-5 lg:mb-0 border-black">
                                ...
                                <div className="lg:w-[30%] w-full lg:h-auto h-auto bg-gray-100">
                                    <img src={item.imgSrc} alt="Media Images" className="object-fill lg:h-[122px]" />
                                </div>
                    ...
                    >
                        <div className="flex lg:flex-row flex-col   border-[1px] border-black" >
                            <div className=" lg:w-[30%]  w-full lg:h-auto h-auto">
                                <img src={anImg1} alt="An Images" className='object-cover lg:h-[122px] ' /></div>
                            <div className=" lg:w-[70%] w-full h-auto lg:px-4 px-2 lg:pt-[13px] pt-[6px] lg:pb-[12px] pb-[10px] ">
