  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://graceful-sarong-bass.cyclic.app/sendEmail",
        formData
      );
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://aartechsolonics.com/contact" />
      </Helmet>
      <Navbar />
      <div className="max-container mainPage  lg:px-20 lg:mt-[4rem] lg:py-20 px-5 py-10 sm:px-10 ">
        <h1 className="title lg:text-4xl text-[28px] text-box-red   font-antonio lg:mt-0 mt-20">
          Contact Us
        </h1>
          ...
          <form onSubmit={handleSubmit}>
            <div className="formDiv lg:grid grid-cols-2 lg:gap-x-[10px] lg:space-y-[12px] space-y-[16px]">
              ...
              <input
                ...
                className="border-[1px] uppercase lg:text-[18px] text-[16px] border-black  outline-none py-2 lg:px-6 px-3 h-[50px] w-full font-Barlow placeholder-red-600 font-medium"
                onChange={(e) =>
            ...
            <textarea
              ...
              className="border-[1px] uppercase lg:text-[18px] text-[16px] border-black lg:h-[160px] mt-4  outline-none py-2 lg:px-6 px-3 w-full font-Barlow placeholder-red-600 font-medium resize-none h-[149px]"
              onChange={(e) =>
                setFormData({ ...formData, message: e.target.value })
              }
            />
            <button
              className="font-Barlow font-bold bg-box-red text-white p-2 lg:text-[18px] text-[16px] mt-3 lg:w-32 w-[100%] h-12 cursor-pointer"
              type="submit"
            >
              SUBMIT
            </button>
        ...
        <div className="emailLinks">
          <div className="generic flex space-x-8 font-Barlow lg:mt-9 mt-6">
            <h2 className="text-box-red text-[16px] lg:text-2xl lg:w-60 w-[7.4rem] whitespace-nowrap leading-6">
              GENERIC QUERY
            </h2>
            <a href="mailto:info@aartechsolonics.com">
              {" "}
          ...
          <div className="seles flex space-x-8 font-Barlow">
            <h2 className="text-box-red text-[16px] lg:text-2xl  lg:w-60 w-[7rem] whitespace-nowrap">
              SALES QUERY
            </h2>
            <a href="mailto:sales@aartechsolonics.com">
              <h2 className=" text-[16px] lg:text-2xl font-semibold">
                sales@aartechsolonics.com
              </h2>
            </a>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 lg:gap-x-7 lg:gap-y-[30px] gap-y-6 ">
          <div className="addressbox border-[1px] border-black w-[100%] lg:h-[323px] h-auto py-4 px-4">
            ...
            <div className="boxContent flex flex-col leading-[26px] space-x-10 font-[400]">
              <ul className="list-disc lg:ml-9 ml-6 ">
                <a href="https://goo.gl/maps/NYPZGaFHh2MLaXMK8" target="_blank">
                  <li className="font-Barlow  lg:w-[320px] lg:text-[20px] my-4  text-foot-blue">
                    “Ashirwad” E2/57, Arera Colony, Bhopal, Madhya Pradesh
                    (M.P.) India 462016
                  </li>
                </a>
          ...
          <div className="addressbox border-[1px] border-black w-[100%] lg:h-[323px] h-auto py-4 px-4">
            ...
            <div className="boxContent flex flex-col leading-[26px] lg:space-x-10 font-[400] ">
              <ul className="list-disc  lg:ml-8 ml-6 ">
                <a href="https://goo.gl/maps/Z45HNNGJcqrP7KA39" target="_blank">
                  <li className="font-Barlow lg:text-[20px] my-4 w-full text-foot-blue">
                    35-A/36 Sector-B, Industrial Area, Mandideep, District
                ...
                <a href="tel:+919993091168">
                  <li className="font-Barlow lg:text-[20px] w-[106%] lg:mt-4 mb-0 text-foot-blue">
                    Mob No. +91-9993091168,
                    <a href="tel:+917389905790">
          ...
          <div className="addressbox border-[1px] border-black w-[100%] lg:h-[323px] h-60 py-4 px-4 ">
            ...
            <div className="boxContent flex flex-col leading-[26px] lg:space-x-10 font-[400] ">
              <ul className="list-disc  lg:ml-9 ml-6 ">
                <a
                  href="https://maps.app.goo.gl/h93sv4ZW1JgBFHa99"
                  target="_blank"
                >
                  <li className="font-Barlow lg:text-[20px] my-4 w--full text-foot-blue ">
                    Near Him Cold Storage, Sector-1A, Parwanoo District Solan,
