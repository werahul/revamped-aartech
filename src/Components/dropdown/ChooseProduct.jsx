...
const ChooseProduct = () => {
  const options = ["PUREWAVE DSTATCOM"];
  const [selectedOption, setSelectedOption] = useState('CHOOSE PRODUCT');
    ...
    <div className="relative">
      <button
        ...
        className={`flex items-center px-6 py-2 focus:outline-none w-full transition mt-4  text-box-red font-bold ${
          isButtonClicked && (selectedOption === 'CHOOSE PRODUCT' || isDropdownOpen)
