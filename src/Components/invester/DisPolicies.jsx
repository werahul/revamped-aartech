  ...
  return (
    <div>
      <Helmet>
        <meta
          name="title"
          content="Policy Disclosures"
          data-react-helmet="true"
        />
        <meta
          name="description"
          content="Official company policies for compliance and transparency."
        />
        <link
          rel="canonical"
          href="https://aartechsolonics.com/investors/disclosures-policies"
        />
      </Helmet>
      <Navbar />
      <SlideinBarInvester />
      <div className="relative lg:mt-[10.5rem] mt-[4.4rem]">
        ...
        <h1 class="text-foot-blue  absolute lg:bottom-10 bottom-5 lg:left-20 2xl:left-[7.5rem] left-5 lg:text-4xl text-[28px] font-normal font-antonio leading-9">
          Disclosures
        </h1>
      </div>
      ...
      <div className=" 2xl:px-[120px] lg:py-20 lg:px-20  lg:pt-10 px-5 py-10  lg:mt-0  sm:px-10">
        ...
        <div class="text-black lg:text-4xl text-[28px] font-normal font-antonio leading-9 lg:mt-8 mt-6">
        ...
        <div class="lg:w-[841px] h-auto border border-black lg:px-8 px-5 lg:py-8 py-5">
          <div className="flex flex-col justify-between gap-y-3 h-auto]">
            ...
            <a
              href="https://drive.google.com/file/d/1_75-HEEEFfYNXEWx6X18bidAYU5DoFpg/view"
              target="_blank"
            >
              {" "}
              <div class="text-black lg:text-lg text-sm font-normal font-Barlow underline leading-snug hover:font-semibold">
            ...
            <a
              href="https://drive.google.com/file/d/1PkK9LN6aVXTedxCU6CC4zldprAiZMfiv/view"
              target="_blank"
            >
              {" "}
              <div class="text-black lg:text-lg text-sm font-normal font-Barlow underline leading-snug hover:font-semibold">
            ...
            <a
              href="https://drive.google.com/file/d/1Xukq3S6JPVFM-wE5o0KTMLof2ugX4mow/view"
              target="_blank"
            >
              {" "}
              <div class="text-black lg:text-lg text-sm font-normal font-Barlow underline leading-snug hover:font-semibold">
            ...
            <a
              href="https://drive.google.com/file/d/1St1zMD9-p59t3gUxR762zqx5wbkX3MvW/view"
              target="_blank"
            >
              {" "}
              <div class="text-black lg:text-lg text-sm font-normal font-Barlow underline leading-snug hover:font-semibold">
            ...
            <a
              href="https://drive.google.com/file/d/1-a9zybUezRcV6HG6jLH2uTlX-GFzvjtN/view"
              target="_blank"
            >
              {" "}
              <div class="text-black lg:text-lg text-sm font-normal font-Barlow underline leading-snug hover:font-semibold">
            ...
            <a
              href="https://drive.google.com/file/d/1k-WjTHrnmQ0F1M_98iAvRmO7OoXNWVXi/view"
              target="_blank"
            >
              {" "}
              <div class="text-black lg:text-lg text-sm font-normal font-Barlow underline leading-snug hover:font-semibold">
