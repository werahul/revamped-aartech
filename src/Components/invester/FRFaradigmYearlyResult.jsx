  ...
  return (
    <div>
      <Helmet>
        <meta
          name="title"
          content="Faradigm Yearly Reports"
          data-react-helmet="true"
        />
        <meta
          name="description"
          content="Financial results and performance updates for Faradigm."
        />
        <link
          rel="canonical"
          href="https://aartechsolonics.com/investors/financial-reports-faradigm-subsidiary-yearly-results"
        />
      </Helmet>
