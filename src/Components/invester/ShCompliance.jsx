      ...
      <div className="max-container lg:py-20 lg:px-20  lg:pt-9 px-5 py-10  lg:mt-0 mt-5 sm:px-10">
        ...
        <div class="lg:w-[841px] h-auto border border-black lg:px-8 px-5 lg:py-8 py-5">
          <div className="flex flex-col justify-between gap-y-3 h-auto ">
            ...
            >
              {" "}
              <div class="lg:w-[95%] text-black lg:text-lg text-sm font-normal font-Barlow underline leading-snug hover:font-semibold">
                Certificate pursuant to Regulation 7(3) of SEBI (LODR)
            ...
            <a
              href="https://drive.google.com/file/d/1YtjS4rNiSUd9ERRjqdaH-csPntutLJV-/view"
              target="_blank"
            >
              {" "}
              <div class="lg:w-[95%] text-black lg:text-lg text-sm font-normal font-Barlow underline leading-snug hover:font-semibold">
                Certificate pursuant to Regulation 7(3) of SEBI (LODR)
                Regulations, 2015 for half year ended March 31, 2020
              </div>
            </a>
          </div>
        </div>
