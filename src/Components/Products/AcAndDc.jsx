...
import { ac1, ac2, ac3, ac4, ac5 } from "../../assets/proImages";
...
const AcAndDc = () => {
  ...
  const images = [ac1, ac2, ac3, ac4, ac5];
  ...
  return (
    ...
    <Helmet>
        <meta
          name="title"
          content="AC & DC Power Solutions"
          data-react-helmet="true"
        />
        <meta
          name="description"
          content="Reliable alternating and direct current systems for diverse applications."
        />
        <link
          rel="canonical"
          href="https://aartechsolonics.com/products/ac-and-dc"
        />
      </Helmet>
      <Navbar />
      <SlideInBar />
      <div className="max-container  lg:pt-28 lg:px-20  pt-20 px-5 lg:mt-0 mt-5 sm:px-10">
          ...
          <div className="lg:w-[55%] w-[100%] lg:ml-[44px]">
            ...
            <div className="flex flex-col justify-between  lg:h-[330px]">
              <div className="text-black lg:text-[22px] text-base lg:font-normal font-medium font-Barlow mt-6 lg:leading-tight leading-snug">
                J. Schneider offers DC UPS systems with
                microcontroller-supported charging and discharging, load
                shedding, and customisable backup times, ensuring control and
                process protection. These systems, with a 0.2 to 600 A range,
                are compatible with 12/24/48 V DC voltages and are ideal for
                safety-critical applications, with German development and
                production. They offer robust technology, cascading
                capabilities, and customisability for complete systems, making
                them a reliable choice for power stability in critical
                applications.
              </div>
        ...
        <div className="lg:flex  justify-start lg:mt-4 mt-2 ">
          <div className="text-black lg:text-2xl text-base space-y-1 lg:font-normal font-medium font-Barlow lg:leading-tight leading-snug">
            ...
            <p className="list-dots">
              The large product range in the power range 0.2 - 600 A
            </p>
        ...
        <div className="text-black lg:text-2xl text-base lg:font-normal font-medium font-Barlow lg:leading-tight leading-snug lg:mt-4 mt-2">
          Aartech excels in tailoring J. Schneider's DC UPS systems to diverse
          requirements, offering customisation for complete systems. With
          programmable features, compatibility with various voltages, and German
          engineering, they ensure reliability for critical applications,
          guaranteeing power stability.
        </div>
