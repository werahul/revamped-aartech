...
import { pbu1, pbu2, pbu3, pbu4, pbu5 } from "../../assets/solutionImages";
...
const PowerBackup = () => {
  ...
  const images = [pbu1, pbu2, pbu3, pbu4, pbu5];
  ...
  return (
    ...
    <Helmet>
        <meta
          name="title"
          content="Power Backup Unit"
          data-react-helmet="true"
        />
        <meta
          name="description"
          content="Dependable backup systems for critical energy needs."
        />
        <link
          rel="canonical"
          href="https://aartechsolonics.com/solutions/power-backup-unit"
        />
      </Helmet>
      <Navbar />
      <SlideInBar />
        ...
        <div className="lg:flex lg:mt-20">
          ...
          <div className="lg:w-[55%] w-[100%] lg:ml-[44px]">
            ...
            <div className="text-black lg:text-[22px] text-base lg:font-normal font-medium font-Barlow mt-6 lg:leading-tight leading-snug">
              The Power Backup Unit is a dependable system vital for
              uninterrupted power supply in challenging situations, such as
              remote defence outposts and exploration missions. It combines
              backup generators, energy storage, and renewable energy
              integration to guarantee power reliability in harsh conditions.
              This solution ensures the uninterrupted operation of
              mission-critical equipment and communication systems, ultimately
          ...
          >
            <div className=" sm:w-[100%] lg:w-[100%] w-[100%] h-auto sm:p-2 p-0 lg:p-0">
              <img
                src={fuel}
                alt="fuel"
                className="sm:w-[100%] lg:w-[90%] w-[100%]"
              ></img>
            </div>
            <div className=" text-black lg:text-2xl text-base lg:font-normal font-medium font-Barlow sm:ml-5 sm:mt-0 mt-4  lg:leading-tight leading-snug">
              Fuel Cells are a favoured power source for diverse applications
              due to their high efficiency, extended endurance, compact size,
              lightweight portability, silent operations, durability, wide
              operating range, and eco-friendly nature. They outperform
              conventional IC engine options in efficiency, endurance, and
              environmental impact, making them ideal for various defence and
