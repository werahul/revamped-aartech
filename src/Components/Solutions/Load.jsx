  ...
  return (
    <div>
      <Helmet>
        <meta
          name="title"
          content="Load Limiting Technology"
          data-react-helmet="true"
        />
        <meta
          name="description"
          content="Optimizing power distribution with intelligent load management."
        />
        <link
          rel="canonical"
          href="https://aartechsolonics.com/solutions/load-limiting"
        />
      </Helmet>
      <Navbar />
      <SlideInBar />
        ...
        <div className="lg:flex lg:mt-20">
          ...
          <div className="lg:w-[55%] w-[100%] lg:ml-[44px]">
            ...
            <div className="text-black lg:text-[22px] text-base lg:font-normal font-medium font-Barlow mt-6 lg:leading-tight leading-snug">
              Load limiting is a strategy to manage energy demand effectively,
              aiming for fairness and practicality. It's essential in addressing
              energy supply challenges, particularly in areas with high demand.
              By controlling the amount of electricity used, it ensures fair
              distribution and minimises non-technical losses for distribution
              utilities.
            </div>
          </div>
        </div>
        ...
        <div className="proContainer">
          ...
          >
            ...
            <div className=" text-black lg:text-2xl text-base lg:font-normal font-medium font-Barlow sm:ml-5 sm:mt-0 mt-4  lg:leading-tight leading-snug">
              LoadChecker automatically cuts the power supply when excess
              current flows. Its patented self-reset feature restores power
              after a brief load disconnection, requiring no manual
              intervention. This employs soft-blocking technology for longevity.
            </div>
          </div>
        </div>
