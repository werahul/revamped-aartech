...
import { enrg1, enrg2, enrg3, enrg4, enrg5 } from "../../assets/solutionImages";
...
const Energy = () => {
  ...
  const images = [enrg1, enrg2, enrg3, enrg4, enrg5];
  ...
  return (
    ...
    <Helmet>
        <meta
          name="title"
          content="Energy Storage Innovations"
          data-react-helmet="true"
        />
        <meta
          name="description"
          content="Smart solutions for efficient energy retention and usage."
        />
        <link
          rel="canonical"
          href="https://aartechsolonics.com/solutions/energy-storage"
        />
      </Helmet>
      <Navbar />
      <SlideInBar />
        ...
        <div className="lg:flex lg:mt-20">
          ...
          <div className="lg:w-[55%] w-[100%] lg:ml-[44px]">
            ...
            <div className="text-black lg:text-[22px] text-base lg:font-normal font-medium font-Barlow mt-6 lg:leading-tight leading-snug">
              Energy storage technologies tap into micro sources like solar,
              wind, and hydropower through PV panels, micro wind turbines, and
              micro-hydro turbines. Stored energy powers portable devices,
              benefiting sectors like Marine, Defense, Space, Remote Sensing,
              Telecom, and Real Estate. Applications include soldier
              communication and decorative lighting using solar tiles, enhancing
        ...
        <div className="proContainer">
          ...
          >
            ...
            <div className=" text-black lg:text-2xl text-base lg:font-normal font-medium font-Barlow sm:ml-5 sm:mt-0 mt-4  lg:leading-tight leading-snug">
              A flywheel stores energy through rotational momentum, helping
              stabilise power grids by providing system "inertia." Inertia Drive
              technology focuses on efficient design and assembly processes. The
              flywheel container offers modular scalability, quick installation,
              and high-power delivery, with excellent efficiency and operational
              flexibility.
            </div>
          </div>
        </div>
