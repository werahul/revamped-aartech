...
const Solar = () => {
    ...
    return (
        ...
        <meta
          name="title"
          content="Solar Design Engineering"
          data-react-helmet="true"
        />
        <meta
          name="description"
          content="Custom solar solutions for maximum energy efficiency."
        />
        <link
          rel="canonical"
          href="https://aartechsolonics.com/solutions/solar-design-engineering"
        />
      </Helmet>
            <Navbar />
            <SlideInBar/>
            <div className="max-container  lg:pt-28 lg:px-20   px-5 pt-20 lg:mt-0 mt-5 sm:px-10">
                ...
                <h1 className="lg:hidden text-black text-[28px] font-normal font-antonio ">Solar Design, Engineering & Consultancy Services
                </h1>
                ...
                <div className="proContainer">
                    ...
                    <div className={`Pro1 flex sm:flex-row flex-col justify-start items-start mt-8 ${selectedProTag === 'PTag1' ? '' : 'hidden'}`}>
                        <div className=" sm:w-[100%] lg:w-[80%] w-[100%] h-auto sm:p-2 p-0 lg:p-0">
                            <img src={solar} alt="solar" className='sm:w-[100%] w-[100%]'></img>
                        </div>
